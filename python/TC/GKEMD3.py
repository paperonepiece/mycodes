...
lowside = 0.2 
upside = 0.8    # TC averaging interval
...
Tc     = np.mean(AveK[int(lowside*Nt):int(upside*Nt)])
Tcx    = np.mean(AveKx[int(lowside*Nt):int(upside*Nt)])
Tcy    = np.mean(AveKy[int(lowside*Nt):int(upside*Nt)])
Tcz    = np.mean(AveKz[int(lowside*Nt):int(upside*Nt)])
